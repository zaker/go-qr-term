...
var CharCapTable []CharCap = []CharCap{{1, L, 41, 25, 17, 10},
	{1, M, 34, 20, 14, 8},
	{1, Q, 27, 16, 11, 7},
	{1, H, 17, 10, 7, 4},
	{2, L, 77, 47, 32, 20},
...
func GetLowestQRVersionByte(byteLength int, el ErrorCorrectionLevel) (int, error) {
	capsWithErrorLevel := make([]CharCap, 0)
	...
	return 0, errors.New("Cannot support the amount of data")
}
